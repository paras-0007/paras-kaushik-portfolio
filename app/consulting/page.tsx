...
export default function ConsultingPage() {
  return (
    <main>
      ...
      <header className="page-hero"><div className="aurora-bg" /><div className="container"><div className="status-pill"><span /> Taking on focused consulting engagements</div><p className="kicker">CONSULTING</p><h1>Ship your AI feature <em>without the guesswork.</em></h1><p className="hero-sub">I help teams turn uncertain AI opportunities into measurable systems - then build the difficult parts required to get them into users&apos; hands.</p><div className="hero-actions"><a className="btn primary" href="#contact">Start a conversation</a><a className="btn secondary" href="#services">See services ↓</a></div></div></header>

      <section className="section" id="services"><div className="container"><div className="section-head"><span className="section-index">01 / SERVICES</span><h2>What I help with.</h2><p>Every service below is grounded in systems I have already built and operated.</p></div><div className="offers-grid">{services.map(([n,title,copy]) => <TiltCard key={n}><article className="offer-card glass"><span>{n}</span><h3>{title}</h3><p>{copy}</p></article></TiltCard>)}</div></div></section>

      <section className="section engagement-section"><div className="container"><div className="section-head"><span className="section-index">02 / ENGAGEMENTS</span><h2>Ways to work together.</h2></div><div className="models-grid"><TiltCard><article><span>QUICK START</span><h3>AI Diagnostic</h3><p>A focused review of the problem, data, current architecture, risks, and next experiments.</p><ul><li>Architecture and feasibility</li><li>Evaluation plan</li><li>Prioritized action memo</li></ul><a className="btn secondary" href="#contact">Book a diagnostic</a></article></TiltCard><TiltCard><article className="highlight"><span>MOST COMMON</span><h3>Project Build</h3><p>A defined AI capability delivered from evaluation baseline through a production-ready handoff.</p><ul><li>Model and system implementation</li><li>APIs and deployment</li><li>Documentation and knowledge transfer</li></ul><a className="btn primary" href="#contact">Scope a project</a></article></TiltCard><TiltCard><article><span>ONGOING</span><h3>Fractional AI Engineer</h3><p>Embedded technical ownership for teams that need senior AI execution without a full-time hire.</p><ul><li>Weekly engineering ownership</li><li>Model and product decisions</li><li>Team enablement</li></ul><a className="btn secondary" href="#contact">Discuss a retainer</a></article></TiltCard></div></div></section>
